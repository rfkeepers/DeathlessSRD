...
const moves = [
   ...
   },
   {
      ...
      type: types.move,
      tags: ['Sightseer'],
      routeContent: 'One of the Sightseer persona moves.',
   ...
   },
   {
      ...
      type: types.move,
      tags: ['Chameleon'],
      routeContent: 'One of the Chameleon persona moves.',
   ...
   },
   {
      ...
      type: types.move,
      tags: ['Illusionist'],
      routeContent: 'One of the Illusionist persona moves.',
      component: BadFaith,
   },
   {
      name: 'Bad Karma',
      type: types.move,
      tags: ['Witch'],
      routeContent: 'One of the Witch persona moves.',
      component: BadKarma,
   },
   {
      name: 'Bail!',
   ...
   },
   {
      ...
      type: types.move,
      tags: ['Shadewalker'],
      routeContent: 'One of the Shadewalker persona moves.',
   ...
   },
   {
      ...
      type: types.move,
      tags: ['Martyr'],
      routeContent: 'One of the Martyr persona moves.',
   ...
   },
   {
      ...
      type: types.move,
      tags: ['Empath'],
      routeContent: 'One of the Empath persona moves.',
   ...
   },
   {
      ...
      type: types.move,
      tags: ['Dominion'],
      routeContent: 'One of the Dominion persona moves.',
      component: Cower,
   },
   {
   ...
   
   {
      ...
      type: types.move,
      tags: ['Glutton'],
      routeContent: 'One of the Glutton persona moves.',
   ...
   },
   {
      ...
      type: types.move,
      tags: ['Pyro'],
      routeContent: 'One of the Pyro persona moves.',
   ...
   },
   {
      ...
      type: types.move,
      tags: [tags.modifierMove],
      routeContent: 'The move for helping out other players.',
      component: HelpOut,
   },
   {
      name: 'Hobnob',
   ...
   },
   {
      ...
      type: types.move,
      tags: ['Venom'],
      routeContent: 'One of the Venom persona moves.',
      component: Imbibe,
   },
   {
      name: 'Immolate',
