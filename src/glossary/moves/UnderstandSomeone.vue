...
<Move id="template" leftLined>
    ...
    <template v-slot:body>
        ...
        <Options bullet="⇀" :options="[
            ...
            'What detail about you, your past or culture would help me understand you?',
    ...
    <template v-slot:example>
        ...
        The non-standard options here are mostly because I wanted to play around.  There's a couple that I wanted to avoid specifically: "are you lying?" is just something that characters don't get to know.  Though I'm sure MCs will figure out a way to convey that with the "subtle signals" option.  "How could I get you to __?" is reserved for Persuasion.  The rest are standard enough.  It's a sufficient list, but I bet I'll weed and replace some in testing. 
        ...
        <p>"So he's not just being dismissive.  You realize he tries not to look any of you in the face at all.  You get the impression that he's actually worried.  Like, sure, making you wait is an alpha play, but he doesn't seem totally convinced that he's in control right now.  What else?"</p>
        <p>"Is he avoiding anything else, besides us?"</p>
        <p>"Okay, so, I'm going to give you the reverse of that, sort of.  He's not avoiding Marienne.  She's the one person he looks at.  And he looks at her a lot."</p>
        </div>
    </template>
</Move>
</template>
