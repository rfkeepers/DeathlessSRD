...
<Move id="template" leftLined>
    ...
    <template v-slot:body>
        When you <b>press an NPC for something</b> they wouldn't easily agree to, <Roll>{{stat}}</Roll>.  <em>S:</em> They will tell you the most effective way to compel them- if there is a way- otherwise they'll decline your request peacefully.  <em>P:</em> They need extra convincing- if they can be convinced; either the MC will pick an option from the list or they will reject your request in a noisy, aggressive, destructive, or alarming manner.
        ...
        <br>
        When you press a fellow PC to do things after they have given valid reasons to not get involved, they may shut you down once and for all or let you roll for it.  If they let you roll, <Roll>3 DICE</Roll>.  <em>S:</em> They take 1 Resilience.  <em>P:</em> They choose 1.  <em>M:</em> They choose 2.  
        <Options bullet="⇀" :options="[
