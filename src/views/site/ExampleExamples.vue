...
.exampleExamples :deep(.example .body) {
    border-left-color: $color-background-pop;
    background-color: $color-background-sink;
}
.exampleExamples :deep(.icon) {
